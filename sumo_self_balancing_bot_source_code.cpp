...
//#define KD_RAISEUP 20   //kd兴起
//#define KP_THROTTLE_RAISEUP 0  //没有对raiseup速度控制
//#define KI_THROTTLE_RAISEUP 0.0//油门兴起

//Tune here.
/*P determines the force with which the robot will correct itself. A lower P shows robot’s inability to 
  balance itself and a higher P will shows the violent behavior. */
/*D determines the sensitivity of robot to the error in its state. It is used to smoothen/depress the robot oscillations. 
  A lower D is unable to remove oscillations and a higher D will cause violent vibrations.*/
#define KP 0.185 //higher the KP, higher the KD.
#define KD 28.255
...
float stabilityPDControl(float DT, float input, float setPoint,  float Kp, float Kd)
{
  ...
  //Serial1.print(Kd*(error-PID_errorOld));Serial1.print("\t");
